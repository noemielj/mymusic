...
function Header() {
	...
	return (
		<header className={styles.header}>
			...
			<div className={styles.headerIcons}>
                {/* Icône faEye pour afficher à nouveau les articles masqués */}
                <FontAwesomeIcon onClick={toggleHideArticles} className={styles.userSection} icon={faEye} />
